...
$(document).ready(function() {
	if ($("#wmd-button-row").length > 0) {
		...
		function() {
			var mycolor = $("#laqoo-color option:selected").val();
		...
		function() {
			var myab = $("#laqoo-bilibili option:selected").val();
		...
		function() {
			var myab = $("#laqoo-colorful option:selected").val();
			if(myab == 'timeline'){
				textContent = '\r\n' + '!!!' + '\r\n' + '<div class="laqoo-timeline">' + '\r\n' + '    <div class="laqoo-timeline-title"><span>时间轴标题</span></div>' + '\r\n' + '    <div class="laqoo-timeline-item"><span>时间轴1内容</span></div>' + '\r\n' + '    <div class="laqoo-timeline-item"><span>时间轴2内容（可删除可复制此行）</span></div>' + '\r\n' + '</div>' + '\r\n' + '!!!' + '\r\n';
			}else if(myab == 'messageReceive'){
				textContent = '\r\n' + '!!!' + '\r\n' + '<div class="laqoo-message-receive">' + '\r\n' + '    <div class="laqoo-message-user"><img src="头像图片链接" alt="avatar" /><span>名字</span></div>' + '\r\n' + '    <div class="laqoo-message-word"><span>信息内容</span></div>' + '\r\n' + '</div>' + '\r\n' + '!!!' + '\r\n';
			}else if(myab == 'messageSend'){
				textContent = '\r\n' + '!!!' + '\r\n' + '<div class="laqoo-message-send">' + '\r\n' + '    <div class="laqoo-message-user"><img src="头像图片链接" alt="avatar" /><span>名字</span></div>' + '\r\n' + '    <div class="laqoo-message-word"><span>信息内容</span></div>' + '\r\n' + '</div>' + '\r\n' + '!!!' + '\r\n';
			}else if(myab == 'linkCardIcon'){
				textContent = '\r\n' + '!!!' + '\r\n' + '<a href="链接地址" class="laqoo-link-card" target="_blank">' + '\r\n' + '  <div class="link-card-left"><i class="link-card-img fa fa-link"></i></div>' + '\r\n' + '  <div class="link-card-right">' + '\r\n' + '    <span class="link-card-title">链接标题</span>' + '\r\n' + '    <span class="link-card-desc">链接描述</span>' + '\r\n' + '    <span class="link-card-tip">链接域名（如: t.co）</span>' + '\r\n' + '  </div>' + '\r\n' + '</a>' + '\r\n' + '!!!' + '\r\n';
